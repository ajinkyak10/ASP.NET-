...
<head runat="server">
    <title>Delete Student Profile | Modern School</title>
                ...
                <div class="spacer1">
                    <div class="form-group">              
                        <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b><label class="control-label" style="margin-top:10px;">Roll No.</label></b>
                                    <asp:TextBox ID="roll" pattern='^[0-9]*' class="form-control" placeholder="Student Roll Number" runat="server" OnTextChanged="roll_TextChanged"></asp:TextBox>
                                </div>                              
                            </div>                          
                            </div>                        
                        </div>            
