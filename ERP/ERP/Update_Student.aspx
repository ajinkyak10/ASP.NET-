<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Student.aspx.cs" Inherits="Update_Student" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update Student Profile | Modern School</title>
...
<body>
    <form id="form1" runat="server">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="roll" required class="form-control" placeholder="Roll Number To Be Update" runat="server" OnTextChanged="roll_TextChanged"></asp:TextBox>
                                </div>
                            </div>                                                                            
                            </div>                        
                        </div>            
        ...
        <hr>
		<h2 style="margin-left:550px; font-family:Calibri; color:teal;">Student Personal Details</h2>		<!--SECOND HEADER-->
		</hr>
        <hr />
        ...
        <div class="container">    
            ...
            <div class="form-group">               
                    <div class="col-sm-10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <b><label class="control-label">New Roll Number</label></b>
                                
                                <asp:TextBox ID="nroll" pattern='^[0-9]*'  class="form-control" placeholder="Enter New Roll Number" runat="server" OnTextChanged="nroll_TextChanged"></asp:TextBox>
                            </div>
                        </div>      
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                ...
                                <asp:TextBox ID="fname" pattern='[A-Za-z \\s]*' class="form-control" placeholder="First Name Of Student" runat="server" OnTextChanged="fname_TextChanged"></asp:TextBox>
                            </div>                             
                        </div>                            
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <b><label class="control-label">Middle Name</label></b>                               
                                <asp:TextBox ID="mname" pattern='[A-Za-z \\s]*' placeholder="Middle Name Of Student" class="form-control" runat="server" OnTextChanged="mname_TextChanged"></asp:TextBox>
                            </div>                                                         
                        </div>    
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                ...
                                <asp:TextBox ID="lname" pattern='[A-Za-z \\s]*' class="form-control" placeholder="Last Name Of Student" runat="server" OnTextChanged="lname_TextChanged"></asp:TextBox>
                            </div> 
                        </div>    
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                ...
                                <asp:TextBox ID="ladd" pattern="^[a-zA-Z0-9_.-]*$" TextMode="MultiLine" Rows="4" class="form-control" style="margin-top:10px" runat="server" OnTextChanged="ladd_TextChanged"></asp:TextBox>
                            </div>                             
                        </div>                            
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <b><label class="control-label">Permanent Address</label></b>         
                                <asp:TextBox ID="padd" pattern="^[a-zA-Z0-9_.-]*$" TextMode="MultiLine" Rows="4" class="form-control" style="margin-top:10px" runat="server" OnTextChanged="padd_TextChanged"></asp:TextBox>
                            </div>                                                         
                        </div>                                
                        </div>                        
                    </div>            
