...
public partial class Update_Faculty : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = @"UPDATE eregister SET teacherid='"+ntid.Text+"',class='"+standard.Text+"',fname='"+fname.Text+"',mname='"+mname.Text+"',lname='"+lname.Text+"',dob='"+dob.Text+"',contact='"+contact.Text+"',gender='"+male.Text+"',ladd='"+ladd.Text+"',padd='"+padd.Text+"' ";

        sda.UpdateCommand = new SqlCommand(sql, sc);
        sda.UpdateCommand.ExecuteNonQuery();        

        string msg = "Faculty Details Have Been Updated Successfully.";
    ...
    protected void ntid_TextChanged(object sender, EventArgs e)
    {
